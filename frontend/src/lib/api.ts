...
export async function getAdminSessionAddresses(
  window: SessionWindow = "live",
...
/** Failed logins grouped by address; `live` reads as the last 24 hours. */
export async function getAdminSessionFailedLogins(
  window: SessionWindow = "day",
